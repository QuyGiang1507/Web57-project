...
function Authentication() {
    const [activePanel, setActivePanel] = useState("auth__container");

    return (
        <div className={activePanel} id="auth__container">
            ...
            <div className="overlay-container">
                <div className="overlay">
                    <div className="overlay-panel overlay-left">
                        ...
                        <button 
                            className="btn ghost" 
                            onClick={e => setActivePanel("auth__container")}
                        >Sign In</button>
                    </div>
                    <div className="overlay-panel overlay-right">
                        ...
                        <button 
                            className="btn ghost" 
                            onClick={e => setActivePanel("auth__container right-panel-active")}
                        >Sign Up</button>
                    </div>
                </div>
            </div>
